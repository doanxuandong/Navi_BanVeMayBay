<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControl.ascx.cs" Inherits="sidleshow_WebUserControl" %>
<script src="/NaVi/sidleshow/jquery-1.9.1.min.js" type="text/javascript"></script>
    ...
    <script>
     ...
     <div id="slider1_container" style="position: relative; width: 1000px;
        ...
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 200px;
            overflow: hidden;">
            <div>
            <img u="image" src="/NaVi/sidleshow/01.jpg" style="height: 278px; width: 1000px; " 
                    width="1000px"  />               
            </div>
            <div> 
                <img u="image" src="/NaVi/sidleshow/02.jpg" ;width="1000px" />                
            </div>
            <div> 
                <img u="image" src="/NaVi/sidleshow/03.jpg" ;width="1000px" />                
            </div>
            <div>
                <img u="image" src="/NaVi/sidleshow/04.jpg" ;width="1000px" />               
            </div>
