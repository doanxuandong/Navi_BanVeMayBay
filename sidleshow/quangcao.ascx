<%@ Control Language="C#" AutoEventWireup="true" CodeFile="quangcao.ascx.cs" Inherits="sidleshow_WebUserControl" %>
<script src="/NaVi/sidleshow/jquery-1.9.1.min.js" type="text/javascript"></script>
    <script src="/NaVi/sidleshow/jssor.js" type="text/javascript"></script>
    <script src="/NaVi/sidleshow/jssor.slider.js" type="text/javascript"> 
    </script><style type="text/css">s
    body
    {
        margin:0;padding:0; background:#fff; font-family: Arial, Verdana, Sans-Serif;
    }
        ...
        .bricon
        {
            background: url(/NaVi/img/browser-icons.png);
        }
    </style>
    <script>
     ...
     <div id="slider1_container" style="position: relative; width: 475px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background:url(/NaVi/sidleshow/loading.gif) no-repeat center center;
                top: 0px; left: 0px;width: 100%;height:100%;">
            </div> 
        </div> 
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top:0px; width: 475px; height: 250px;
            overflow: hidden;">
           
             <div>
                <img u="image" src="/NaVi/sidleshow/quangcao1.jpg" ;width="475px" />               
            </div>
             <div>
                <img u="image" src="/NaVi/sidleshow/quangcao2.jpg" ;width="475px" />               
            </div>
             <div>
                <img u="image" src="/NaVi/sidleshow/quangcao3.jpg" ;width="475px" />               
            </div>
             <div>
                <img u="image" src="/NaVi/sidleshow/quangcao4.jpg" ;width="475px" />               
            </div>
             <div>
                <img u="image" src="/NaVi/sidleshow/quangcao5.jpg" ;width="475px" />               
            </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url(share-icons.png);/*NaVi/sidleshow/*/
                }
        ...
        .share-stumbleupon {
            ...
            <img u="any" class="qr_code" src="/NaVi/img/logo.jpg" 
                
                    
                    style="position: absolute; width: 160px; height: 155px; bottom: 22px; right: 812px; opacity: .9; filter: alpha(opacity=90);" />
            &nbsp;&nbsp;<!-- Example to add fixed static QR code in slider END --></div> 
        ...
        <style>
            ...
            */
            ...
            .jssorb03 div, .jssorb03 div:hover, .jssorb03 .av {
                ...
                color: white;
                font-size: 12px;
                background: url(b03.png) no-repeat;/*/NaVi/sidleshow/*/
                overflow: hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora20l, .jssora20r {
                ...
                height: 55px;
                cursor: pointer;
                background: url(a20.png) no-repeat;/*/NaVi/sidleshow/*/
                overflow: hidden;
            }
