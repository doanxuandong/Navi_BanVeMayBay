<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="thu_Default" %>

<%--<%@ Register src="/NaVi/ctrl/bank.ascx" tagname="bank" tagprefix="uc1" %>--%>
...
<head runat="server">
    ...
    <script src="jssor.js" type="text/javascript"></script>
    <script src="jssor.slider.js" type="text/javascript"></script>
    <title></title>
</head>
<body>
    ...
    <script>
     ...
     <div id="slider1_container" style="position: relative; width: 1000px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 200px;
            overflow: hidden;">
            <div>
            <img u="image" src="04.jpg" align="middle" width="1000px" height="200px" />               
            </div>
            <div> 
        ...
        .share-stumbleupon {
            ...
            <img u="any" class="qr_code" src="../hinh/logo.jpg" 
                
                    
                    style="position: absolute; width: 160px; height: 155px; bottom: 22px; right: 812px; opacity: .8; filter: alpha(opacity=80);" />
        ...
        <style>
            ...
            */
            .jssora20l, .jssora20r {
                ...
                height: 55px;
                cursor: pointer;
                background: url(a20.png) no-repeat;
                overflow: hidden;
            }
